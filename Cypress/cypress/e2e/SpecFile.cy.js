...
describe("Automation Suite for Yaksha Application", () => {
  ...
  it("TS-11 Verify the tooltip text on hover of Star icon in Laboratory", () => {
    laboratoryPage.verifyStarTooltip();
    verifyUserIsOnCorrectURL("Lab/Dashboard");
  });

  it('TS-12 Add and Verify New Imaging Type in Radiology', () => {
    settingsPage.addAndVerifyNewImagingType();
    verifyImagingTypeAdded();
  });

  it("TS-13 Web Element Handling for Dropdowns in Purchase Request", () => {
